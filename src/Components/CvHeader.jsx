...
const CvHeader = ({ activeLayout }) => {
  ...
  return (
    <div className={`${colorClasses[selectedColor]} w-full flex gap-4 flex-col items-center ${activeLayout === 'top' ? 'justify-center h-40' : 'h-full items-start flex flex-grow-0 w-2/8 p-8'}`}>
